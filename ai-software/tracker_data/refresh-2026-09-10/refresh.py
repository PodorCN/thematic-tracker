"""Reproduce Sep 10 refresh. Run from repo root:
env -u PYTHONPATH uv run --isolated --python 3.11 --with yfinance --with pandas python THEME/tracker_data/refresh-2026-09-10/refresh.py
...
ASOF="2026-09-10"
PRIOR="2026-09-09" if BANK else "2026-09-08"
