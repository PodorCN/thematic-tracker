"""Sep 18 post-close refresh (covers settled Sep 18 close). Run from repo root:
env -u PYTHONPATH uv run --isolated --python 3.11 --with yfinance --with pandas python THEME/tracker_data/refresh-2026-09-18-pm/refresh.py
