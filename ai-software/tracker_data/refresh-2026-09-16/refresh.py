"""Reproduce Sep 16 refresh. Run from repo root:
env -u PYTHONPATH uv run --isolated --python 3.11 --with yfinance --with pandas python THEME/tracker_data/refresh-2026-09-16/refresh.py
